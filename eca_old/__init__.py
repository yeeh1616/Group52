...
class Context:
    ...
    def __init__(self, init_data=None, name='<unnamed context>', rules=rules):
        ...
        # subscribe to global pubsub channel to receive global eca_old events
...
def context_switch(context):
    ...
    different from the eca_old Context.)
...
def context_activate(context):
    """
    Activate an eca_old Context. If None is passed, this function should
    disable the context.
    """
    # stash old context
